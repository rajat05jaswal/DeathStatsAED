 ...
 * @author saboo
 */
public class CrimeJPanel extends javax.swing.JPanel {
    ...
    public CrimeJPanel(JPanel container, Organization organization, UserAccount account, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        accidentAreaBtn.setText("Total Police Deployed");
        ...
        accidentRateBtn.setText("Get Crime Rate");
        ...
        jLabel2.setText("Deaths Due to Crime");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(accidentRateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 1101, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(92, 92, 92)
                        .addComponent(CrimeproneLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 917, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 1079, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(33, 33, 33)
                .addComponent(accidentRateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addComponent(CrimeproneLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void accidentAreaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accidentAreaBtnActionPerformed
        ...
        if(business.getHashPolice().size()!=0){
            int noOfPolice=0;
            for(Map.Entry<String, ArrayList<PoliceMan>> entry: business.getHashPolice().entrySet()){
                noOfPolice+=entry.getValue().size();
            }
            CrimeproneLabel.setText("Total Police Deployed =" + noOfPolice);
            CrimeproneLabel.setVisible(true);
        }
        else{
            CrimeproneLabel.setText("Police Department is working on assiging Police, No police Assigned yet.");
            CrimeproneLabel.setVisible(true); 
        }
    ...
    private void accidentRateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accidentRateBtnActionPerformed
       ...
       double accidentPercentage =0;
        ...
        accidentPercentage = (crimeCount/totalDeaths)*100;
        DecimalFormat df = new DecimalFormat("####0.00");
        accidentRateLabel.setText("The Crime Rate is " + df.format(accidentPercentage) +"%");
